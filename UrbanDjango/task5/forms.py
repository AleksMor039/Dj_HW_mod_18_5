'''
Создайте форму UserRegister, наследованную от Django
формы с аналогичными параметрами, как и в шаблоне
'''
...
class UserRegister(forms.Form):
    ...
    age = forms.CharField(min_length=3, label="Введите свой возраст", required=True)